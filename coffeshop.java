public class CoffeeShop {
    ...
    public static Customer customer1 = new Customer("Kite", 200);
    public static Customer customer2 = new Customer("Cedric", 0);
    public static Customer customer3 = new Customer();
    public static Customer customer4 = new Customer("Janine", 0);
